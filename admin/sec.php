...
### www.mastop.com.br
### =============================================================
### $Id: sec.php,v 1.1.1.1 2007/04/30 23:18:58 topet05 Exp $
### =============================================================
...
switch ($op) {
	...
	default:
		...
		$c['tipo'][3] = "none";
		$c['show'][3] = '($reg->contaDestaques() > 0) ? $reg->contaDestaques()." <a href=\''.XOOPS_URL.'/modules/'.MGO_MOD_DIR.'/admin/go2.php?op=listar_dstac&sec_10_id=".$reg->getVar($reg->id)."'.'\' title=\''.MGO_ADM_GO2.'\'><img src=\'images/view.gif\' align=\'absmiddle\' alt=\''.MGO_ADM_GO2.'\'></a>": 0;';
		$c['nosort'][3] = 1;
